...
export class Manager {
  ...
  idl: Idl = idl as Idl
  program: Program
  public constructor(connection: web3.Connection, network: Network, opts?: web3.ConfirmOptions) {
    ...
    if (network === Network.LOCAL) {
      this.program = new Program(idl as Idl, new web3.PublicKey(idl.metadata.address), provider)
    } else {
