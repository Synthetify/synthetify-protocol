...
A Trader performs exchanges of assets using Synthetify exchange. To engage in trading activity a trader needs firstly to buy synthetic assets from other markets like centralized exchanges or mint it himself by acting as a Staker.

### Liquidator

To ensure safety and solvency of the protocol, Liquidator can pay off debt of under collateralized Staker and receive fair share of Staker's collateral.
